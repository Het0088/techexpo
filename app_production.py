...
# Model paths
ALPHABET_MODEL_PATH = os.environ.get('ALPHABET_MODEL', 'ml/models/isl_landmark_2hand_best.h5')
ALPHABET_CLASS_PATH = os.environ.get('ALPHABET_CLASSES', 'ml/models/landmark_2hand_class_indices.json')
WORD_MODEL_PATH = os.environ.get('WORD_MODEL', 'ml/models/isl_words_best.h5')
WORD_CLASS_PATH = os.environ.get('WORD_CLASSES', 'ml/models/word_class_indices.json')
...
if __name__ == '__main__':
    if DEBUG:
        ...
        # Use waitress for Windows or gunicorn for Linux
        try:
